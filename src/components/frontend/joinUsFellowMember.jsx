                ...
                <div>
                    ...
                    <div className="flex gap-8 mt-4">
                        ...
                        <section className="font-IBM w-3/4">
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-800 mt-8">Why Become a Fellow Member?</h3>
                            <ul className="list-disc list-inside text-gray-600 text-lg space-y-2 text-justify">
                                <li>Access to IASSRD’s open-access journals and research publications.</li>
                                <li>Invitations to exclusive webinars, workshops, and international conferences.</li>
                                <li>Networking with global experts in social sciences and related fields.</li>
                                <li>Opportunities to contribute to peer review and editorial processes.</li>
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-800 mt-8">Membership Categories</h3>
                            <p className="text-gray-600 text-lg text-justify">IASSRD offers a range of fellow membership categories tailored to your experience and qualifications:</p>
                            <ul className="list-disc list-inside text-gray-600 text-lg space-y-2 mt-2 text-justify">
                                <li>
                                    <strong>Fellow Member</strong>: For graduates/postgraduates with at least 5 years of professional experience in social sciences or related fields.
                                </li>
                                <li>
                            ...
                            <h3 className="text-xl font-bold mb-4 text-gray-800 mt-8">Membership Fee</h3>
                            <p className="text-gray-600 text-lg text-justify">
                                The annual membership fee is <span className="font-bold">$125</span>, providing full access to IASSRD’s resources, including journal subscriptions, event participation, and networking platforms.
                            </p>
                            ...
                            <p className="text-gray-600 text-lg text-justify">
                                Join IASSRD by submitting your application through the form on this page or by emailing your CV to{" "}
                                <a
                                    href="mailto:iassrd.editor@gmail.com"
                                    className="text-indigo-600 hover:text-indigo-800 hover:underline transition-colors duration-300"
                                    aria-label="Email iassrd.editor@gmail.com for membership inquiries"
                        ...
                        {/* Form Section (Right) */}
                        <section className="font-IBM w-1/2" aria-labelledby="apply-membership-heading">
                            <h3 id="apply-membership-heading" className="text-2xl font-bold mb-4 text-center text-gray-700">
                                Fellow Membership Form
                            </h3>
                            <div className="max-w-7xl p-6 rounded-lg font-IBM">
                                <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-6">
