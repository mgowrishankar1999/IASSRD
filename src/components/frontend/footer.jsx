        ...
        <>
            ...
            <footer className="bg-gray-200 h-[55vh] px-[80px] py-4">
                ...
                <div className='flex text-center items-center mb-2 justify-center  '>
                    <div>
                        <a href="/">
                            ...
                            <img className='object-contain h-20 w-24 rounded' src={Iassrdlogo} alt='iassrd Logo' />
                        </a>
                    </div>

                    <div className='text-center  mt-3 text-3xl font-bold text-gray-700'>International Academy for Social Sciences
                ...
                <div className=" border-y  border-gray-300  flex  justify-between mt-4 py-10">
                    <div className='border-r border-gray-300 pl-3 pr-10'>
                        <h3 className="text-blue-700 font-bold text-xl mb-2">| <span className='text-xl font-bold text-gray-800'>Publish with Us</span></h3>
                        <ul className="text-gray-500 space-y-2 text-md font-medium">
                            ...
                            <li><a href="/open-access" className="text-gray-600 hover:text-blue-700">- Open Access Policy</a></li>
                    ...
                    <div className='border-r border-gray-300 pl-4 pr-10'>
                        <h3 className="text-blue-700 font-bold text-xl mb-2">| <span className='text-xl font-bold text-gray-800 '>Resources for</span></h3>
                        <ul className="text-gray-500 space-y-2 text-md font-medium ">
                            <li><a href="/profile-search" className=" text-gray-600 hover:text-blue-700">- Author Search</a></li>
                            <li><a href="/joinus-editorial" className=" text-gray-600 hover:text-blue-700">- Reviewers</a></li>
                            <li><a href="/editorial-policy" className=" text-gray-600 hover:text-blue-700">- Editorial Policy</a></li>
                    ...
                    <div className='border-r border-gray-300 pl-4 pr-10'>
                        ...
                        <h3 className="text-blue-700 font-bold text-xl mb-2">| <span className='text-xl font-bold text-gray-800 '>Publishing Standards</span></h3>

                        <ul className="text-gray-500 space-y-2 text-md font-medium ">
                            {/* <li><a href="#" className=" text-gray-600 hover:text-blue-700">- Our Policies</a></li> */}
                            <li><a href="/publication-ethics" className=" text-gray-600 hover:text-blue-700">- Publication Ethics</a></li>
                            <li><a href="/terms-and-conditions" className=" text-gray-600 hover:text-blue-700">- Terms and Conditions</a></li>
                            <li><a href="/privacy-policy" className=" text-gray-600 hover:text-blue-700">- Privacy Policy</a></li>
                        </ul>
                    </div>

                    <div>
                        {/* <h3 className="text-blue-700 font-bold">Contact Us <span className="text-blue-700">✔</span></h3> */}
                        <h3 className="text-blue-700 font-bold text-xl mb-2">| <span className='text-xl font-bold text-gray-800 '>Connect</span></h3>
                        <div className="flex  flex-col justify-between items-center  space-y-4">
                            <a href="mailto:iassrd.editor@gmail.com">
                                <img
            ...
            <div className=' flex  py-2  justify-center items-center space-x-2 font-semibold bg-gray-200'>
