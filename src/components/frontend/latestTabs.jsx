...
//     // Filter articles based on active tab (adjust based on API response fields)
//     const filteredArticles = articles.filter((article) => {
//         // Assuming a 'discipline' or similar field exists in the API response
//         const disciplineMap = {
...
//         };
//         return article.discipline === disciplineMap[activeTab] || activeTab === "Recently Published";
//     });

//     return (
//         <>
//             <div className="flex items-center space-x-6 px-[80px] py-[15px] overflow-x-auto">
//                 {["Recently Published", "Most Cited", "Most Viewed", "Most Downloaded"].map((discipline) => (
//                     <button
//                         key={discipline}
//                         className={`px-4 h-[35px] font-medium text-[16px]  transition-colors duration-300 whitespace-nowrap
//               ${activeTab === discipline ? "border-b-2 border-blue-500 text-blue-500" : "transition-transform duration-200 ease-in-out hover:-translate-y-[1px] text-stone-700 hover:text-blue-500 border-b-2 border-stone-600 hover:border-blue-500"}`}
...
//                 ))}
//             </div>
//             <div>latest views citations and downlaods have to show </div>
    ...
    return (
        <>
            ...
            {filteredArticles.length === 0 ? (
                <div className="text-center text-gray-600 px-[80px] py-6">No articles found.</div>
            ) : (
                <>
