...
//                     />
//                     <div className="w-[75vw] ps-6 h-auto">
//                         <p className="text-3xl text-blue-800 font-bold mb-2">
//                             {journal?.journalName || "Journal"}
//                         </p>
...
//                                 <div
//                                     key={article.articleId}
//                                     className={`pb-6 mt-3 ${index === articles.length - 1 ? "border-b-0" : ""
//                                         } mb-1`}
//                                 >
//                                     <div className="flex items-center space-x-3 mb-2">
//                                         <span className="text-sm font-medium text-indigo-600">Research Article</span>
        ...
        <>
            ...
            >
                <div className="flex ">
                    ...
                    />
                    <div className="w-[75vw] ps-6 h-auto">
                        <p className="text-3xl text-blue-800 font-bold mb-3">
                            {journal?.journalName || "Journal"}
                        </p>
                        <div className="border-b border-gray-300 mb-"></div>
                        {/* <p className="text-xl text-gray-700 font-semibold mb-8">
                            Volume {displayVolume}, Issue {displayIssue}, {articles.length > 0 ? `${articles[0].monthFrom} - ${articles[0].monthTo}` : "Loading..."}, {year || "Loading..."}
                        </p> */}
                        ...
                        {loading ? (
                            ...
                            <p className="text-gray-600">This issue is currently awaiting publication. New and engaging articles will be available here soon.</p>
                        ) : (
                            articles.map((article, index) => (
                                <div
                                    key={article.articleId}
