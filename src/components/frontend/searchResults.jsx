...
const SearchResults = () => {
    ...
    // Filter journals based on articles
    const filteredJournals = localJournals.filter((journal) =>
                            ...
                            {currentArticles.map((article, index) => (
                                ...
                                >
                                    ...
                                    {article.abstractText && (
                                        <div className="text-sm text-gray-700 mb-4">
                                            <span className="font-medium">Abstract: </span>
                                            <p className={`text-justify ${expandedAbstracts[article.articleId] ? '' : 'line-clamp-2 '}`}>
                                                {article.abstractText.replace(/<[^>]+>/g, '')}
                                            </p>
                                            <button
                                                onClick={() => toggleAbstract(article.articleId)}
