...
// //     const [joinUsMembers, setJoinUsMembers] = useState([]);
...
// //     // Fetch joinus members from API
// //     useEffect(() => {
// //         const fetchJoinUsMembers = async () => {
// //             try {
// //                 const response = await axios.get(`${BASE_URL}/joinus`);
// //                 setJoinUsMembers(response.data); // Assuming the API returns an array directly
// //             } catch (err) {
// //                 setError("Error fetching joinus members: " + err.message);
// //             } finally {
// //                 setLoading(false);
// //             }
// //         };
...
// //     // Handle search
// //     const filteredMembers = joinUsMembers.filter(
// //         (item) =>
...
// //                 axios.delete(`${BASE_URL}/joinus/${id}`).then((response) => {
...
// //             setSuccess("JoinUs members deleted successfully!");
// //             setTimeout(() => setSuccess(null), 3000);

// //             setShowDeleteModal(false);
// //         } catch (err) {
// //             setError("Error deleting joinus members: " + err.message);
// //         } finally {
// //             setLoading(false);
// //         }
// //     };
...
// //             const memberToEdit = joinUsMembers.find((m) => m.id === selectedRows[0]);
// //             navigate("/addnewjoinus", { state: { joinUsMember: memberToEdit } });
// //             window.scrollTo(0, 0);
// //         }
// //     };
...
// //                     <h1 className="text-2xl font-bold">JoinUs Dashboard</h1>
// //                     <p className="text-sm opacity-90 mt-1">Manage joinus members and their details.</p>
// //                 </header>
...
// //                                 <th className="p-3 text-left">Member Category</th>
...
// //                                             className="h  h-5 w-5 text-blue-500 border-blue-200 rounded focus:ring-blue-400"
// //                                         />
// //                                     </td>
// //                                     <td className="p-3">{startIndex + index + 1}</td>
// //                                     <td className="p-3">{item.memberCategory}</td>
